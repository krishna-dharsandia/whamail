...
namespace MailBridge.API.Migrations
{
    ...
    [Migration("20260710200231_AddWhatsAppSession")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MailBridge.API.Models.Audience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MailBridge.API.Models.Broadcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MailBridge.API.Models.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MailBridge.API.Models.WhatsAppSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MailBridge.API.Models.Broadcast", b =>
                {
                    b.HasOne("MailBridge.API.Models.Audience", "Audience")
                        .WithMany("Broadcasts")
            ...
            modelBuilder.Entity("MailBridge.API.Models.EmailQueue", b =>
                {
                    b.HasOne("MailBridge.API.Models.Broadcast", "Broadcast")
                        .WithMany("Emails")
            ...
            modelBuilder.Entity("MailBridge.API.Models.WhatsAppSession", b =>
                {
                    b.HasOne("MailBridge.API.Models.AppUser", "User")
                        ...
                        .HasForeignKey("MailBridge.API.Models.WhatsAppSession", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
